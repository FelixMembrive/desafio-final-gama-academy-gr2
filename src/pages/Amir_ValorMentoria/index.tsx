...
export default function Amir_ValorMentoria() {
    return (
        <Container className="">
            ...
            <Row className=" fw-semibold dados_monitora d-flex flex-column flex-md-row ">

                <h2 className="nome_monitora">Nome</h2>

                <h3 className="area_monitora">Área de atuação</h3>
            ...
            <Row className="lorem2 d-flex flex-column flex-md-row">
                <p className="fw-semibold">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vel risus a nibh placerat volutpat 
            ...
            <Row className=" d-flex flex-column flex-md-row me-4 gy-5 gx-5 ms-0">
