...
export default function HomeDev() {
  return (
    <>
      ...
      <LinkButton to="#" text="primary-custom" variant="primary-custom" className="m-1" />
      ...
      <LinkButton to="#" text="secondary-custom" variant="secondary-custom" className="m-1" />
      ...
      <LinkButton to="#" text="success-custom" variant="success-custom" className="m-1" />
      ...
      <LinkButton to="#" text="warning-custom" variant="warning-custom" className="m-1" />
      ...
      <LinkButton to="#" text="danger-custom" variant="danger-custom" className="m-1" />
