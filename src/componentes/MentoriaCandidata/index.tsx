...
export default function MentoriaCandidata() {
  ...
  return (
    <div className="mentorias-section-candidata py-11 pt-lg-26">
        <h2 className="titulo-mentoria-candidata text-start ms-7 ms-lg-24 mb-xs-3 mb-lg-11">Vagas recomendadas para você</h2>
        ...
        {dados.map((cardInfo, index) => {
            return (
                <Card className="card-mentoria border-0 p-xs-4 p-lg-7">
                    <Card.Body className="card-mentoria-body d-flex m-0 p-0">
