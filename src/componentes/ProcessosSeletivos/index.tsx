...
export default function ProcessosSeletivos() {
    ...
    return (
        <div className="process-section d-flex flex-column justify-content-between p-4">
                ...
                <LinkButton to='/register' text='Envie seu currículo' className='btn-processos btn mx-auto ms-lg-0 p-3 mb-4 rounded-pill d-flex justify-content-center align-items-center'/>
        </div>
    );
}